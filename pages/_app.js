...
export default class MyApp extends App {
  static async getInitialProps({ Component, router, ctx }) {
    ...
    if (isServer) {
      ...
      if (pageProps && pageProps.isServer) pageProps.isServer = true
    } else {
      ...
      if (pageProps) pageProps.user = user
    }
    return { pageProps }
  }
  ...
  render() {
    ...
    // this means that we are now running on client but it is first page load, not a redirect to this page
